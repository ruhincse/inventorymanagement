                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        <div class="header">
                            ...
                            <center> <span class="badge bg-blue mx-auto"><h2> Today Total Expense : {{$todayexp}}<h2></span></center>  <br>  

                              <center> <span class="badge bg-green mx-auto"><h2> Monthly Total Expense : {{$monthlyexp}}<h2></span></center>   <br>

                              <center> <span class="badge bg-red mx-auto"><h2> Yearly Expense : {{$yearlyexp}}<h2></span></center> 
                        </div>
                        <div class="body">
                            <div class="table-responsive">
                                <table class="table table-bordered table-striped table-hover dataTable js-exportable">
                                    ...
                                    <tbody>
                                     ...
                                     <a href="{{route('admin.expense.edit',$data->id)}}" class="btn btn-primary"> <i class="material-icons">edit</i> </a>
                                     <button type="submit" onclick="delEmp('{{$data->id}}')" class="btn btn-danger">  <i class="material-icons">delete</i></button>

                                      <form id="delete-form-{{$data->id}}" action="{{route('admin.expense.destroy',$data->id)}}" method="post"> 
                                          @csrf
                                          @method('DELETE')
                                       </form>
                                            </td>
