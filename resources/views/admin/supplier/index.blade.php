                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td> 
                                               ...
                                               <a href="{{route('admin.supplier.show',$data->id)}}" class="btn btn-info"> <i class="material-icons">visibility</i> </a>



                                                <a href="{{route('admin.supplier.edit',$data->id)}}" class="btn btn-primary"> <i class="material-icons">edit</i> </a>

                                                <button class="btn btn-danger" onclick=" delEmp( {{$data->id}} )"> <i  class="material-icons">delete</i> </button>
                                                    <form id="form-action-{{$data->id}}" action="{{route('admin.supplier.destroy',$data->id)}}" method="POST">
                                                        @csrf
                                                        @method('DELETE')
        ...
        <div class="form-group">
          ...
          <div class="form-group">
            <label for="exampleFormControlInputa">Account Number</label>
             <div class="form-line">
            <input type="number" class="form-control" id="exampleFormControlInputa" name="account_number" >
          </div>
            </div>
