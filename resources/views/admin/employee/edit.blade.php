...
@section('content')
  <section class="content">
      ...
      <form action="{{route('admin.employee.update',$data->id)}}" method="POST" enctype="multipart/form-data">
        @csrf
        @method('PUT')
    <div class="body">
          ...
          <div class="form-group">
            ...
            <label for="exampleFormControlInputd">Designation</label>
             <div class="form-line">
            <input type="text" class="form-control" value="{{$data->designation}} "  id="exampleFormControlInputd" name="designation">
          </div>
            </div>
          ...
          <div class="form-group">
            <label for="exampleFormControlInputa">Account Number</label>
             <div class="form-line">
            <input type="number" class="form-control" value="{{$data->account_number}}" id="exampleFormControlInputa" name="acc_number" >
          </div>
            </div>
      ...
      <div class="modal-footer">
        <a href="{{route('admin.employee.index')}}" class="btn btn-danger" data-dismiss="modal">Back</a>
